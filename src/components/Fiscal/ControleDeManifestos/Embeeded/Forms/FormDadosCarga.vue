<template>
  <v-row dense>
    <v-col md="3" class="ps-4 position-relative">
      <div class="top-0 position-sticky">
        <v-card
          class="bg-grey-ligthen-4 elevation-1 border"
        ...
        >
          ...
          <div class="pa-4 rounded-md d-flex flex-column ga-3 overflow-y-auto" variant="flat" max-height="450">
            ...
            <v-row class="mb-4">
              ...
              >
                <v-card class="px-2 bg-red-lighten-4 text-redNeveah pa-2" style="border: 1px solid #ba1614;">
                  <div class="d-flex align-center text-body-2 w-100">
